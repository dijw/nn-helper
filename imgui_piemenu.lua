...
local function BeginPiePopup(menuCtx, pName, iMouseButton, fDiameter)
...
local function BeginPieMenu(menuCtx, pName, bEnabled, fDiameter)
    ...
    local fSqrDiameter = fDiameter * fDiameter
